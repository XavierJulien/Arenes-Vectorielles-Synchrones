	...
	public void		run()
	{
		...
		while (true)
		{
			for (i = 0; i < nbTasks; i++)
			{
				...
				for (j = 0; j < nbTasks; j++)
				{
					System.out.println("Ordonnanceur wait n." + i);
...
class				Task extends Thread
{
	...
	public void		setOrdonnanceur(Ordonnanceur or) {ord = or; cond = or.getDoneCondition();}
	...
	public void		run()
	{
		while (true)
		{
			synchronized(ord)
			{
				...
				{
					System.out.println("Task " + idTask + " - Activated");
					// Computations here
				}
			}
