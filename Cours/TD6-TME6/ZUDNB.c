...
static unsigned short __ZUDNB_AwaitedList[6];
static unsigned short __ZUDNB_EmittedList[6];
...
static unsigned short __ZUDNB_AllAwaitedList[6]={3,0,1,2};
...
ZUDNB_O_RESET();
#endif
__AppendToList(__ZUDNB_EmittedList,4);
}
static int __ZUDNB_Check5 [] = {1,0,0};
...
static int __ZUDNB_Check6 [] = {1,0,1,0};
static void __ZUDNB_A7 () {
__ZUDNB_V1 = _false;
}
static int __ZUDNB_Check7 [] = {1,0,1,1};
static void __ZUDNB_A8 () {
__ZUDNB_V2 = _false;
}
static int __ZUDNB_Check8 [] = {1,0,1,2};
...
static int __ZUDNB_Check10 [] = {1,0,1,4};
...
static int __ZUDNB_Check12 [] = {1,1,4,1,4};
static void __ZUDNB_A13 () {
__ZUDNB_V3 = __ZUDNB_V4;
}
static int __ZUDNB_Check13 [] = {1,1,4,1,3};

/* PROCEDURE CALLS */

/* CONDITIONS */

static int __ZUDNB_A14 () {
__ZUDNB_GENERIC_TEST((__ZUDNB_V4>=3)&&((__ZUDNB_V4%3)==0));
}
static int __ZUDNB_Check14 [] = {1,2,4,4,0};
...
static void __ZUDNB_A15 () {
;
__ResetVariable(3);
}
static int __ZUDNB_Check15 [] = {1,0,0};
...
{"ZUDNB",0,"Exercice1","ZUDNB.strl",{1,2,1,0},{1,31,1,0},{0,0,0,0}},
};

struct __SignalEntry __ZUDNB_SignalTable [] = {
{"UN",33,0,0,{1,4,8,0},0,(void*) NULL,0,(void*) NULL,0,(void*) NULL},
{"ZERO",33,0,0,{1,4,12,0},0,(void*) NULL,0,(void*) NULL,0,(void*) NULL},
{"DEUX",33,0,0,{1,4,18,0},0,(void*) NULL,0,(void*) NULL,0,(void*) NULL},
{"NB",2,3,0,{1,5,8,0},0,(void*) NULL,0,(void*) NULL,0,(void*) NULL},
{"RESET",34,0,0,{1,6,8,0},0,(void*) NULL,0,(void*) NULL,0,(void*) NULL}};

struct __InputEntry __ZUDNB_InputTable [] = {
{"UN",62,0,0,-1,0,0,0,ZUDNB_IS_UN,0,{1,4,8,0}},
{"ZERO",17,0,0,-1,0,1,0,ZUDNB_IS_ZERO,0,{1,4,12,0}},
{"DEUX",7,0,0,-1,0,2,0,ZUDNB_IS_DEUX,0,{1,4,18,0}}};

struct __VariableEntry __ZUDNB_VariableTable [] = {
{"__ZUDNB_V0","V0","boolean",-2,2,0,(char*)&__ZUDNB_V0,"UN",0,0,0,{1,4,8,0}},
{"__ZUDNB_V1","V1","boolean",-2,2,0,(char*)&__ZUDNB_V1,"ZERO",0,0,0,{1,4,12,0}},
{"__ZUDNB_V2","V2","boolean",-2,2,0,(char*)&__ZUDNB_V2,"DEUX",0,0,0,{1,4,18,0}},
{"__ZUDNB_V3","V3","integer",-3,1,0,(char*)&__ZUDNB_V3,"NB",0,0,0,{1,5,8,0}},
{"__ZUDNB_V4","V4","integer",-3,0,0,(char*)&__ZUDNB_V4,"compt",0,0,0,{1,8,5,0}}
};
...
1,0,5,3,0,0,2,0,0,0,0,5,0,3,0,0,0,
__ZUDNB_HaltList,
__ZUDNB_AwaitedList,
__ZUDNB_EmittedList,
__ZUDNB_StartedList,
...
E[1] = E[0]&&!((__CheckVariables(__ZUDNB_CheckArray[2]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 2\n"),
#endif
__ZUDNB_A2()));
E[1] = __ZUDNB_R[1]&&E[1];
E[2] = (__CheckVariables(__ZUDNB_CheckArray[1]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 1\n"),
#endif
__ZUDNB_A1())||(__CheckVariables(__ZUDNB_CheckArray[3]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 3\n"),
#endif
__ZUDNB_A3());
E[3] = E[1]&&E[2];
E[4] = E[3]&&(__CheckVariables(__ZUDNB_CheckArray[1]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 1\n"),
#endif
__ZUDNB_A1());
...
E[3] = E[3]&&!((__CheckVariables(__ZUDNB_CheckArray[1]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 1\n"),
#endif
__ZUDNB_A1()));
...
__ZUDNB_A3()));
E[3] = E[5]||E[3];
E[6] = E[3]&&(__CheckVariables(__ZUDNB_CheckArray[14]),
#ifdef TRACE_ACTION
...
if (E[6]) {
__CheckVariables(__ZUDNB_CheckArray[13]);__ZUDNB_A13();
#ifdef TRACE_ACTION
fprintf(stderr, "__ZUDNB_A13\n");
#endif
}
if (E[6]) {
...
if (__ZUDNB_R[0]) {
__CheckVariables(__ZUDNB_CheckArray[15]);__ZUDNB_A15();
#ifdef TRACE_ACTION
fprintf(stderr, "__ZUDNB_A15\n");
#endif
}
if (__ZUDNB_R[0]) {
...
E[0] = E[0]&&(__CheckVariables(__ZUDNB_CheckArray[2]),
#ifdef TRACE_ACTION
fprintf(stderr, "test 2\n"),
#endif
__ZUDNB_A2());
...
if (E[0]) {
__CheckVariables(__ZUDNB_CheckArray[5]);__ZUDNB_A5();
#ifdef TRACE_ACTION
fprintf(stderr, "__ZUDNB_A5\n");
#endif
}
E[7] = !(_true);
if (E[0]) {
