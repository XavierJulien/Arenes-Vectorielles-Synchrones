...
let nb_targets = int_of_string Sys.argv.(1) (*1 pour le mode de jeu normal, > 1 pour le mode de jeu course*)
let nb_obstacles = int_of_string Sys.argv.(2)
...
let rec stringify_lasers p_list = (* string du TICK pour la partie Extension Lasers : avec les vitesses et l'angle *)
	...
	|[] -> ""
let rec stringify_coordsXY points_list = (* nouveau strindigy pour les obstacles car ne peut réutiliser le stringify_coords qui s'appliquent aux joueurs *)
